...
% fs_cvmanova - implementation of the cross-validated MANOVA (originally
% Allefeld & Haynes, NeuroImage, 2014, github.com/allefeld/cvmanova) with
% additional funtionality and optimized for time series data by Florian
% Sandhaeger, 2023
%
% if using, please cite Sandhaeger et al., Plos Biology, 2023, as well as
% Allefeld & Haynes, NeuroImage 2014
%
% inputs: cfg - decoding parameters
%         cfg.trialinfo.XXX - contains values for each trial for variable
%                             XXX
%         cfg.varsDec - cell array with names of variables to decode &
%                       control
%         data - channels x time x trials matrix
